...
for t in range(run_times):
    ...
    optimizer = MSEWOA(fitness=benchmark.Sphere,
    ...
    optimizer = MSEWOA(fitness=benchmark.Rastrigin,
    ...
    optimizer = MSEWOA(fitness=benchmark.Ackley,
    ...
    optimizer = MSEWOA(fitness=benchmark.Griewank,
    ...
    optimizer = MSEWOA(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = MSEWOA(fitness=benchmark.Rosenbrock,
    ...
    optimizer = MSEWOA(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = MSEWOA(fitness=benchmark.Quartic,
    ...
    optimizer = MSEWOA(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = MSEWOA(fitness=benchmark.Penalized1,
    ...
    optimizer = MSEWOA(fitness=benchmark.Penalized2,
    ...
    optimizer = MSEWOA(fitness=benchmark.Schwefel_226,
    ...
    optimizer = MSEWOA(fitness=benchmark.Step,
    ...
    optimizer = MSEWOA(fitness=benchmark.Kowalik,
    ...
    optimizer = MSEWOA(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = MSEWOA(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = MSEWOA(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = MSEWOA(fitness=Shekel7,
                       D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    table[item]['avg'] += optimizer.gbest_F
    table[item]['time'] += ed - st
    table[item]['ideal'] = ideal_F.Shekel(m=7)
    loss_curves[:, item] += optimizer.loss_curve
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = MSEWOA(fitness=benchmark.Shekel,
                       D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    table[item]['avg'] += optimizer.gbest_F
    table[item]['time'] += ed - st
    table[item]['ideal'] = ideal_F.Shekel(m=10)
    loss_curves[:, item] += optimizer.loss_curve
    ...
    optimizer = MSEWOA(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = MSEWOA(fitness=benchmark.Hartmann6,
    ...
    optimizer = MSEWOA(fitness=benchmark.Zakharov,
    ...
    optimizer = MSEWOA(fitness=benchmark.SumSquares,
    ...
    optimizer = MSEWOA(fitness=benchmark.Alpine,
    ...
    optimizer = MSEWOA(fitness=benchmark.Michalewicz,
    ...
    optimizer = MSEWOA(fitness=benchmark.Exponential,
    ...
    optimizer = MSEWOA(fitness=benchmark.Schaffer,
    ...
    optimizer = MSEWOA(fitness=benchmark.BentCigar,
    ...
    optimizer = MSEWOA(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = MSEWOA(fitness=benchmark.Elliptic,
    ...
    optimizer = MSEWOA(fitness=benchmark.DropWave,
    ...
    optimizer = MSEWOA(fitness=benchmark.CosineMixture,
    ...
    optimizer = MSEWOA(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = MSEWOA(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(MSEWOA).csv')
